...
# Todos los programas hacen evaluaciones condicionales según el valor de sus variables y expresiones. Por lo tanto no todas las líneas de código se ejecutan cuando corre un programa.
...
print(4 < 5 and 6 > 8) # True or False => False
