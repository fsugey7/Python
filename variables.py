# Una de las características más poderosas de los lenguajes de programación como Python, es su habilidad para manipular variables. Una variable es simplemente un nombre que referencia o apunta un valor. Como su nombre lo indica, el valor de la variable puede ir cambiando.

# Las variables permiten mantener valores en la memoria del computador 
name = "Estudiando Python"

name = name + "!"
# Reasignación de variable. Ahora la variable apunta un valor completamente diferente
name = "Hola Mundo"
...
people = 4
tables = 5
# Print puede recibir varia variables, cada una separada por ","
print(people,tables)
